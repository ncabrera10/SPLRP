...
public class MSHEnvironment {
	...
	public static void setOptimizationCriterion(OptimizationSense criterion){
		MSHEnvironment.setCriterion(criterion);
	}
	...
	public static Solution getBound() {
		return bound;
	}

	public static void setBound(Solution bound) {
		MSHEnvironment.bound = bound;
	}

	public static StopWatch getAssemblyTimer() {
		return assemblyTimer;
	}

	public static void setAssemblyTimer(StopWatch assemblyTimer) {
		MSHEnvironment.assemblyTimer = assemblyTimer;
	}

	public static OptimizationSense getCriterion() {
		return criterion;
	}

	public static void setCriterion(OptimizationSense criterion) {
